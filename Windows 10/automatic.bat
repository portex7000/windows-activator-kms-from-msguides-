...
if "%version%"=="Microsoft Windows 10 Home" (
...
rem Remove potential carriage return character from the version string
set version=%version:~0,-1%

rem Initialize key variable
set "KEY="

rem Determine product key based on version
if "%version%"=="Microsoft Windows 10 Home" (
    set "KEY=TX9XD-98N7V-6WMQ6-BX7FG-H8Q99"
) else if "%version%"=="Microsoft Windows 10 Home N" (
    set "KEY=3KHY7-WNT83-DGQKR-F7HPR-844BM"
